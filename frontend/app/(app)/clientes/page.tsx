        ...
        {loading ? (
          ...
          <div className="py-16 flex flex-col items-center gap-2 text-gray-400">
            ...
            <p className="text-sm font-medium">
              {search ? "Sin resultados para la búsqueda" : "Todavía no hay clientes"}
            </p>
          </div>
        ) : (
              ...
              {clientes.map((c) => (
                <tr key={c.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-4 py-3 text-gray-600 hidden sm:table-cell">
                    {c.telefono ? (
                      <a href={`tel:${c.telefono}`} className="hover:text-blue-600 transition-colors">
                        {c.telefono}
                      </a>
                    ) : (
                  ...
                  <td className="px-4 py-3 text-gray-500 hidden lg:table-cell max-w-xs truncate">
                    {c.direccion || <span className="text-gray-400">—</span>}
                  </td>
